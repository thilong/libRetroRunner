...
public:
    ...
    * be ignored for InputContext streams because they are generally kept as empty as possible.
    *
    ...
    */
     ...
     *
     * InputContext latency is the time it takes to a given frame to travel from an analog-to-digital
